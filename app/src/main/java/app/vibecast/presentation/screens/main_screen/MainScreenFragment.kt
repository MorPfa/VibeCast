                ...
                .observe(viewLifecycleOwner) { weatherState ->
                    if(weatherState.combinedData != null){
                        weatherState.combinedData.weather.currentWeather?.let { currentWeather ->
                            ...
                            val weather =
                                weatherState.combinedData.weather.currentWeather?.weatherConditions?.get(0)?.mainDescription
                            ...
                            binding.centerTempRow.centerWeather.text =
                                weatherState.combinedData.weather.hourlyWeather?.get(1)?.weatherConditions?.get(0)?.mainDescription
                            ...
                            binding.centerTempRow.rightWeather.text =
                                weatherState.combinedData.weather.hourlyWeather?.get(2)?.weatherConditions?.get(0)?.mainDescription
